...
$expectedControlRefs = @(
    $LimitsPath,
    $PromptPath,
    (Join-Path $RepoRoot "scripts\fast3\agent\resume_fast3_r4_two_stage_direction_hard_r24_process_fix_r2.ps1"),
...
$LockPath = Join-Path $StateRoot "active_hard_r24_process_fix_r2.lock.json"
