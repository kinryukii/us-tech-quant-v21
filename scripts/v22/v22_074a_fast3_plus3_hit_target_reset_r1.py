...
V073_CONTRACT=LEGACY_RESULTS_ROOT/'V22.073A_FAST3_PIT_FEATURE_EXPANSION_RESEARCH_R1/feature_contract.json'
...
def run(results_root=LEGACY_RESULTS_ROOT):
 ...
 out=Path(results_root)/OUT_NAME; out.parent.mkdir(parents=True,exist_ok=True); stage=Path(tempfile.mkdtemp(prefix='.074a_',dir=out.parent))
 try:
