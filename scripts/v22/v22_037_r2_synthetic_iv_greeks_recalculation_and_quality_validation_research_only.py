...
REVISION = "V22.037_R2A"
OUTPUT_DIR_NAME = "V22.037_R2_SYNTHETIC_IV_GREEKS_RECALCULATION_AND_QUALITY_VALIDATION_RESEARCH_ONLY"
PASS_STATUS = "PASS_V22_037_R2_SYNTHETIC_IV_GREEKS_RECALCULATED_AND_QUALITY_VALIDATED"
WARN_STATUS = "WARN_V22_037_R2_SYNTHETIC_IV_GREEKS_RECALCULATED_WITH_QUALITY_WARNINGS"
FAIL_INPUT = "FAIL_V22_037_R2_OPTION_INPUT_NOT_FOUND"
FAIL_NO_CALC = "FAIL_V22_037_R2_NO_VALID_IV_GREEKS_CALCULATION"
FAIL_EXCEPTION = "FAIL_V22_037_R2_UNHANDLED_EXCEPTION"
...
OUTPUT_FIELDS = [
    ...
    "valuation_timestamp_et", "underlying_quote_timestamp_et", "days_to_expiry", "time_to_expiry_years",
...
def recalculate_row(
    ...
    valuation_time = valuation_time_override or option_quote_time or underlying_quote_time
    ...
    add_check("valuation_timestamp_source_available", "option or underlying quote timestamp",
              option_quote_time.isoformat() if option_quote_time else (underlying_quote_time.isoformat() if underlying_quote_time else "RUNTIME_FALLBACK"),
              option_quote_time is not None or underlying_quote_time is not None, "WARN")
    ...
    if option_quote_time is not None and underlying_quote_time is not None:
        alignment_seconds = abs((option_quote_time - underlying_quote_time).total_seconds())
    ...
    if option_quote_time is None and underlying_quote_time is None:
    ...
    eligible = iv is not None and not error_failures and quote_quality_pass and alignment_pass
...
def build_schema_mapping(path: Path) -> list[dict[str, Any]]:
    ...
    requirements = {
        ...
        "quote_time": "RECOMMENDED",
        "underlying_quote_time": "RECOMMENDED",
...
def make_summary(
    ...
    return {
        ...
        "output_files": {
            ...
            "report": str(output_dir / "V22.037_R2_synthetic_iv_greeks_recalculation_and_quality_validation_report.txt"),
        },
    }
...
def render_report(summary: Mapping[str, Any]) -> str:
    lines = [
        "V22.037 R2 Synthetic IV/Greeks Recalculation and Quality Validation",
        "=" * 76,
...
def execute(
    ...
    if selected is None:
        ...
        write_json_atomic(output_dir / "v22_037_r2_summary.json", summary)
        (output_dir / "V22.037_R2_synthetic_iv_greeks_recalculation_and_quality_validation_report.txt").write_text(
