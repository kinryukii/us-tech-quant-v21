...
RANKING_FIELDS = [
    ...
    "normalized_market_direction", "direction_scope", "direction_source_fresh", "panel_fresh",
...
TOP_FIELDS = [
    ...
    "direction_scope", "underlying", "required_option_type", "dte_bucket", "contract_code",
...
NO_TRADE_FIELDS = [
    "gate_mode", "official_gate", "shadow_only", "direction_label_raw", "normalized_market_direction",
    "direction_scope", "underlying", "required_option_type", "direction_source_fresh", "panel_fresh",
...
def build_outputs(
    ...
    for mode in modes:
        normalized_direction, scope = normalize_direction(mode["direction_label"])
        ...
        for underlying in universe:
            ...
            for source in candidate_source:
                ...
                row.update({
                    ...
                    "gate_block_reasons": ";".join(reasons + ([] if contract_unexpired else ["NO_UNEXPIRED_MATCHING_CONTRACT"])),
