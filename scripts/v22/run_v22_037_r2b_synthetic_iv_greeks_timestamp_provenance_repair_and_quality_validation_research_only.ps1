...
$MainScript = Join-Path $RepoRoot "scripts\v22\v22_037_r2b_synthetic_iv_greeks_timestamp_provenance_repair_and_quality_validation_research_only.py"
$TestScript = Join-Path $RepoRoot "scripts\v22\test_v22_037_r2b_synthetic_iv_greeks_timestamp_provenance_repair_and_quality_validation_research_only.py"
$OutputDir = Join-Path $RepoRoot "outputs\v22\V22.037_R2B_SYNTHETIC_IV_GREEKS_TIMESTAMP_PROVENANCE_REPAIR_AND_QUALITY_VALIDATION_RESEARCH_ONLY"
...
$LocalTemp = Join-Path $RepoRoot ".tmp\v22_037_r2b"
...
if ($RunTests) {
    ...
    if ($LASTEXITCODE -ne 0) {
        throw "V22.037 R2B tests failed with exit code $LASTEXITCODE"
    }
}
...
$SummaryPath = Join-Path $OutputDir "v22_037_r2b_summary.json"
if (Test-Path $SummaryPath) {
    $Summary = Get-Content $SummaryPath -Raw | ConvertFrom-Json
    Write-Host ""
    Write-Host "=== V22.037 R2B STATUS ===" -ForegroundColor Cyan
    $Summary | Select-Object `
        ...
        valuation_time_enrichment_fallback_count,
        valuation_time_explicit_option_quote_count,
        valuation_timestamp_trust_pass_count,
        underlying_time_reconstructed_from_age_count,
