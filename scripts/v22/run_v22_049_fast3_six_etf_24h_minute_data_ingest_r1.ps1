...
$summary='D:\us-tech-quant-results\fast3\archive\legacy_v22\V22.049_FAST3_SIX_ETF_24H_MINUTE_DATA_INGEST_R1\v22_049_summary.json'; if(-not(Test-Path $summary)){throw "Summary missing: $summary"}; Get-Content $summary -Raw; exit 0
