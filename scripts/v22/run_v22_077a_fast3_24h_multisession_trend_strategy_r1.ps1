...
$out=Join-Path $root '.local_results/v22/V22.077A_FAST3_24H_MULTI_SESSION_TREND_STRATEGY_R1'; $s=Get-Content (Join-Path $out 'v22_077a_summary.json') -Raw | ConvertFrom-Json
