...
$Script = ".\scripts\v22\v22_063a_fast3_after_hours_close_continuation_r1.py"
$Test = ".\scripts\v22\test_v22_063a_fast3_after_hours_close_continuation_r1.py"
$Dependency = ".\scripts\v22\v22_063n_fast3_overnight_vwap_mean_reversion_r1.py"

foreach ($File in @($Python, $Script, $Test, $Dependency)) {
    if (-not (Test-Path $File)) {
        throw "Missing required file: $File"
    }
}

$ResultDir = "D:\us-tech-quant-results\v22\V22.063A_FAST3_AFTER_HOURS_CLOSE_CONTINUATION_BASELINE_R1"
$SummaryFile = Join-Path $ResultDir "v22_063a_summary.json"

$Running = Get-CimInstance Win32_Process |
    Where-Object {
        $_.ProcessId -ne $PID -and
        $_.CommandLine -match "v22_063a_fast3_after_hours_close_continuation"
    }
...
if ($Running) {
    $Running |
        ...
        Format-List
    throw "V22.063A is already running."
}
...
if (Test-Path $SummaryFile) {
    try {
        ...
        if ($Existing.final_status -eq "PASS") {
            Write-Host "V22.063A already completed. Existing PASS result is preserved." -ForegroundColor Green
...
if (Test-Path $ResultDir) {
    ...
    Write-Host "Removed incomplete V22.063A result directory." -ForegroundColor Yellow
}

$TempRoot = "D:\us-tech-quant-results\pytest_temp"
$RunStamp = Get-Date -Format "yyyyMMdd_HHmmss_fff"
$PytestBase = Join-Path $TempRoot "v22_063a_$RunStamp"
...
Write-Host " V22.063A after-hours close continuation"
Write-Host "==============================================" -ForegroundColor Cyan
...
Write-Host ""
Write-Host "Step 3/3: Frozen after-hours baseline" -ForegroundColor Yellow
...
if ($LASTEXITCODE -ne 0) {
    throw "V22.063A study failed: $LASTEXITCODE"
}
