...
Write-Host "PATCH_VERSION: V20.38"
Write-Host "PATCH_NAME: FACTOR_EFFECTIVENESS_ABLATION_AUDIT"
...
python scripts/v20/v20_38_factor_effectiveness_ablation_audit.py
