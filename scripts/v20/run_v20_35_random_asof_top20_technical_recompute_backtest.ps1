...
Write-Host "PATCH_VERSION: V20.35"
Write-Host "PATCH_NAME: RANDOM_ASOF_TOP20_TECHNICAL_RECOMPUTE_BACKTEST"
...
python scripts/v20/v20_35_random_asof_top20_technical_recompute_backtest.py
