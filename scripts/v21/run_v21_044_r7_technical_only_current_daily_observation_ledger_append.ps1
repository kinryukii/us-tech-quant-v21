...
$PythonScript = Join-Path $ScriptDir "v21_044_r7_technical_only_current_daily_observation_ledger_append.py"
...
$SummaryPath = Join-Path $RepoRoot "outputs\v21\review\V21_044_R7_OBSERVATION_DECISION_SUMMARY.csv"
...
Write-Output ("wrapper_append_row_count={0}" -f $Summary.append_row_count)
Write-Output ("wrapper_total_ledger_row_count={0}" -f $Summary.total_ledger_row_count)
