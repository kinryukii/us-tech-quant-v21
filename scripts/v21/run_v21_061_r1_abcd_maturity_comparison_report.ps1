...
$StageScript = Join-Path $ScriptDir "v21_061_r1_abcd_maturity_comparison_report.py"
$OutputDir = Join-Path $RepoRoot "outputs\v21\experiments\momentum_dynamic"
$SummaryPath = Join-Path $OutputDir "V21_061_R1_SUMMARY.json"

Write-Host "STAGE_ID=V21.061-R1"
...
try {
    ...
    if (-not (Test-Path $SummaryPath)) { throw "V21.061-R1 summary was not created." }
