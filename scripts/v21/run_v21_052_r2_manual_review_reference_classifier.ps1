...
$StageScript = Join-Path $ScriptDir "v21_052_r2_manual_review_reference_classifier.py"

Write-Host "STAGE_NAME=V21.052-R2_MANUAL_REVIEW_REFERENCE_CLASSIFIER"
...
try {
    python $StageScript
    if ($LASTEXITCODE -ne 0) { throw "V21.052-R2 failed with exit code $LASTEXITCODE" }
}
