...
$Runner = Join-Path $ScriptDir "v21_022_risk_regime_modifier_robustness_confirmation.py"
$Root = Split-Path -Parent (Split-Path -Parent $ScriptDir)
$Summary = Join-Path $Root "outputs\v21\factor_backtest\V21_022_RISK_REGIME_MODIFIER_ROBUSTNESS_CONFIRMATION_SUMMARY.csv"

python $Runner | Out-Host

if (-not (Test-Path $Summary)) {
    throw "V21.022 summary output not found: $Summary"
}

$SummaryRow = Import-Csv $Summary | Select-Object -First 1
Write-Output "STAGE_NAME=V21_022_RISK_REGIME_MODIFIER_ROBUSTNESS_CONFIRMATION"
...
Write-Output "v21_016_risk_regime_decision=$($SummaryRow.v21_016_risk_regime_decision)"
