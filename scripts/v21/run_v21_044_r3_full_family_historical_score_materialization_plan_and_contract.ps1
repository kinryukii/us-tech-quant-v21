...
$PythonScript = Join-Path $ScriptDir "v21_044_r3_full_family_historical_score_materialization_plan_and_contract.py"
...
$SummaryPath = Join-Path $RepoRoot "outputs\v21\review\V21_044_R3_MATERIALIZATION_DECISION_SUMMARY.csv"
...
Write-Output ("materializable_family_count={0}" -f $Summary.materializable_family_count)
