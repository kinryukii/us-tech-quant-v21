...
$StageScript = Join-Path $ScriptDir "v21_050_r1_v20_dependency_migration_and_cleanup_dry_run.py"

Write-Host "STAGE_NAME=V21.050-R1_V20_DEPENDENCY_MIGRATION_AND_CLEANUP_DRY_RUN"
Write-Host "RESEARCH_ONLY=TRUE"
Write-Host "CLEANUP_DRY_RUN_ONLY=TRUE"
...
try {
    python $StageScript
    if ($LASTEXITCODE -ne 0) { throw "V21.050-R1 failed with exit code $LASTEXITCODE" }
}
