#!/usr/bin/env python
"""Tests for V21.040-R3 context source backfill and selectivity repair."""
...
SCRIPT = ROOT / "scripts" / "v21" / "v21_040_r3_context_source_backfill_and_selectivity_repair.py"
OUT_DIR = ROOT / "outputs" / "v21" / "factors"
REPORT = ROOT / "outputs" / "v21" / "read_center" / "V21_040_R3_CONTEXT_SOURCE_BACKFILL_AND_SELECTIVITY_REPAIR_REPORT.md"

SUMMARY = OUT_DIR / "V21_040_R3_CONTEXT_SELECTIVITY_REPAIR_SUMMARY.csv"
LEDGER = OUT_DIR / "V21_040_R3_CANONICAL_FORWARD_RETURN_LEDGER_REPAIRED.csv"
SOURCE_AUDIT = OUT_DIR / "V21_040_R3_CONTEXT_SOURCE_AUDIT.csv"
MAPPING = OUT_DIR / "V21_040_R3_CONTEXT_REPAIR_MAPPING.csv"
CONTEXT = OUT_DIR / "V21_040_R3_CONTEXT_SELECTIVITY_AND_MATURITY_AUDIT.csv"
PERFORMANCE = OUT_DIR / "V21_040_R3_TECHNICAL_PERFORMANCE_BY_R3_CONTEXT_WINDOW.csv"
QUEUE = OUT_DIR / "V21_040_R3_FORWARD_CONTEXT_REPAIR_QUEUE.csv"
VALIDATION = OUT_DIR / "V21_040_R3_VALIDATION_MATRIX.csv"

REQUIRED = [SUMMARY, LEDGER, SOURCE_AUDIT, MAPPING, CONTEXT, PERFORMANCE, QUEUE, VALIDATION, REPORT]
...
OFFICIAL_GUARD_PATHS = [
    ...
    OUT_DIR / "V21_040_R2_FORWARD_CONTEXT_REPAIR_SUMMARY.csv",
    OUT_DIR / "V21_040_R2_CANONICAL_FORWARD_RETURN_LEDGER.csv",
    OUT_DIR / "V21_040_R2_CONTEXT_SELECTIVITY_AND_MATURITY_AUDIT.csv",
...
def test_v21_040_r3_contract() -> None:
    before = mtimes()
    result = subprocess.run(["python", str(SCRIPT)], cwd=ROOT, text=True, capture_output=True, check=True)
    assert "STAGE_NAME=V21.040-R3_CONTEXT_SOURCE_BACKFILL_AND_SELECTIVITY_REPAIR" in result.stdout
    ...
    assert summary["final_status"].startswith((
        "PASS_V21_040_R3",
        "PARTIAL_PASS_V21_040_R3",
        "BLOCKED_V21_040_R3_INPUTS_MISSING",
    ))
    ...
    for field in {
        ...
        "r2_repaired_context_label",
        "r3_repaired_context_label",
    }:
    ...
    for row in context_rows:
        if row["r3_context_label"] == "MISSING_CONTEXT_LABEL":
...
if __name__ == "__main__":
    test_v21_040_r3_contract()
    print("V21.040-R3 context source backfill tests passed")
